...
def menu_categoria(conexion):
    while True:
        ...
        if opcion_usuario == 1:
            print(EjerciciosPython17CRUD.crear_categoria(conexion))
        
        #Si el usuario elige 2,
        #Llamamos a la funcion leer_categoria
        elif opcion_usuario == 2:
            print(EjerciciosPython17CRUD.leer_categoria(conexion))

        #Si el usuario elige 3,
        #Llamamos a la funcion actualizar_categoria
        elif opcion_usuario == 3:
            print(EjerciciosPython17CRUD.actualizar_categoria(conexion))

        #Si el usuario elige 4,
        #Llamamos a la funcion eliminar_categoria
        elif opcion_usuario == 4:
            print(EjerciciosPython17CRUD.eliminar_categoria(conexion))
...
def menu_producto(conexion):
    while True:
        ...
        if opcion_usuario == 1:
            print(EjerciciosPython17CRUD.crear_producto(conexion))
            
        #Si el usuario elige 2,
        #Llamamos a la funcion leer_producto
        elif opcion_usuario == 2:
            print(EjerciciosPython17CRUD.leer_producto(conexion))

        #Si el usuario elige 3,
        #Llamamos a la funcion actualizar_producto
        elif opcion_usuario == 3:
            print(EjerciciosPython17CRUD.actualizar_producto(conexion))

        #Si el usuario elige 4,
        #Llamamos a la funcion eliminar_producto
        elif opcion_usuario == 4:
            print(EjerciciosPython17CRUD.eliminar_producto(conexion))
...
def menu_cliente(conexion):
    while True:
        ...
        if opcion_usuario == 1:
            print(EjerciciosPython17CRUD.crear_cliente(conexion))
        
        elif opcion_usuario == 2:
            print(EjerciciosPython17CRUD.leer_cliente(conexion))

        elif opcion_usuario == 3:
            print(EjerciciosPython17CRUD.actualizar_cliente(conexion))

        elif opcion_usuario == 4:
            print(EjerciciosPython17CRUD.eliminar_cliente(conexion))
